...
### Introduction
This repository is an ALX SE School Project. The school project consisted in writing a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**, using a limited number of standard library functions, So Instead we used ower own function that we have written over the past three month [Here](https://github.com/ProvLeon/alx-low_level_programming/)
...
`` git clone https://github.com/ProvLeon/simple_shell ``
...
##### List of built-ins
Currently the list of built-ins we wrote are:  
* cd [directory]  
...
```
This Project Was Done in 15 Day


## Authors
* Emmanuel Okantah Lomotey [ProvLeon](https://github.com/ProvLeon)

* Obed Nyame-Antwi [obedwayne](https://github.com/obedwayne)
